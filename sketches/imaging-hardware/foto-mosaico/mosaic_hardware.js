...
function preload() {
    img = loadImage('/vc/content/sketches/imaging-hardware/foto-mosaico/lenna.jpg');
    images = loadImage('/vc/content/sketches/imaging-hardware/foto-mosaico/images.png')
    grayShader = loadShader('/vc/content/sketches/imaging-hardware/foto-mosaico/mosaic_hardware.vert', '/vc/content/sketches/imaging-hardware/foto-mosaico/mosaic_hardware.frag');
    preloadFilesColors();
    preloadAverageImg();
}
...
function preloadAverageImg(){
    let dir_txt = '/vc/content/sketches/imaging/foto-mosaico/images/img_vrg_col.txt'
