...
function preload() {
  img = loadImage('/vc/content/docs/shortcodes/Photomosaic/imaging-hardware/foto-mosaico/lenna.jpg');
  images = loadImage('/vc/content/docs/shortcodes/Photomosaic/imaging-hardware/foto-mosaico/images.png')
  grayShader = loadShader('/vc/content/docs/shortcodes/Photomosaic/imaging-hardware/foto-mosaico/mosaic_hardware.vert', '/vc/content/docs/shortcodes/Photomosaic/imaging-hardware/foto-mosaico/mosaic_hardware.frag');
  preloadFilesColors();
  preloadAverageImg();
}

function preloadFilesColors(){
    let dir_img = '/vc/content/docs/shortcodes/Photomosaic/imaging/foto-mosaico/images/colors/'
...
function preloadAverageImg(){
    let dir_txt = '/vc/content/docs/shortcodes/Photomosaic/imaging/foto-mosaico/images/img_vrg_col.txt'
